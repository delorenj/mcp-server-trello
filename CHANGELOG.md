...
### Added
- **List Management**: `update_list` tool for updating list properties:
  - `update_list(listId, name?, pos?, closed?, subscribed?, idBoard?)` - Update a list's name, position, closed state, subscription, or move it to a different board
